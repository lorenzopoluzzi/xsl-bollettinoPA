                                    ...
                                    <fo:table-cell>
                                        <fo:block margin-left="0.2cm" margin-right="1cm" text-align="right" >
                                            <fo:inline font-weight="bold"> 
                                                <fo:external-graphic src="url('loghi/marchio-grigio.jpg')" content-height="90" content-width="90" />
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>   
                                </fo:table-row>
                                        ...
                                        <fo:table-row> 
                                                <fo:table-cell background-color="#ededed" height="0.5cm">
                                                        <fo:block padding-top="3px" margin-left="1cm">
                                                                ...
                                                                <fo:inline font-family="Roboto Mono" font-weight="normal" font-size="8pt"> <xsl:value-of select="bollettino/cf_ente" /> </fo:inline>
                                                        </fo:block>
                                                </fo:table-cell>
                                                ...
                                                <fo:table-cell background-color="#ededed" height="0.5cm">
                                                        <fo:block padding-top="3px" margin-left="1cm">
                                                                ...
                                                                <fo:inline font-family="Titillium Web" font-weight="normal" font-size="8pt"> Cod. Fiscale </fo:inline>
                                                                <fo:inline font-family="Roboto Mono" font-weight="normal" font-size="8pt"> <xsl:value-of select="bollettino/cf_destinatario" /></fo:inline>
                                                        </fo:block>
                                                </fo:table-cell>   
                                        </fo:table-row>
                                        <fo:table-row> 
                                                ...
                                                <fo:table-cell>
                                                        <fo:block margin-top="0.7cm" margin-left="1cm" font-family="Titillium Web" font-weight="bold" font-size="12pt">
                                                                <xsl:value-of select="bollettino/nome_cognome_destinatario" />
                                                        </fo:block>
                                                        <fo:block margin-top="0.7cm" margin-left="1cm" font-family="Titillium Web" font-weight="regular" font-size="12pt">
                                                                <xsl:value-of select="bollettino/indirizzo_destinatario" />
                                                        </fo:block>
                                                </fo:table-cell>   
                                        </fo:table-row>
                                </fo:table-body>
                                                                        ...
                                                                        <fo:table-row> 
                                                                                <fo:table-cell margin-left="1cm">
                                                                                        ...
                                                                                        <fo:block font-family="Titillium Web" font-weight="normal" font-size="8pt">
                                                                                                <fo:inline> del Tuo ente, </fo:inline>
                                                                                                <fo:inline> di Poste Italiane, </fo:inline>
                                        ...
                                        <fo:table-row>
                                                ...
                                                <fo:table-cell>
                                                        <fo:block text-align-last="justify" margin-top="0.3cm">
                                                                ...
                                                                <fo:inline font-family="Titillium Web" font-weight="bold" font-size="8pt"> <xsl:value-of select="bollettino/nome_cognome_destinatario" /> </fo:inline>
                                                                <fo:leader leader-pattern="space" />
                                                        ...
                                                        <fo:block margin-top="0.3cm">
                                                                ...
                                                                <fo:inline font-family="Titillium Web" font-weight="bold" font-size="8pt"> <xsl:value-of select="bollettino/ente_creditore" /> </fo:inline>
                                                        </fo:block>
                                                        <fo:block margin-top="0.3cm">
                        ...
                        <fo:table margin-top="1cm" table-layout="fixed" width="21.0cm" border-collapse="separate">    
							...
							<fo:block font-family="Titillium Web" font-weight="normal" font-size="6pt">
                                                ...
                                                <fo:table-cell margin-right="1cm">
                                                        ...
                                                        <fo:block margin-top="0.3cm">
                                                                <fo:inline font-family="Titillium Web" font-weight="normal" font-size="8pt">Oggetto pagamento </fo:inline>
                                                                <fo:inline font-family="Titillium Web" font-weight="bold" font-size="8pt"> <xsl:value-of select="bollettino/oggetto_del_pagamento" /> </fo:inline>
                                                        </fo:block>
                                                        <fo:table margin-right="1cm" margin-top="0.5cm" table-layout="fixed" width="14.0cm" border-collapse="separate">    
                                                                <fo:table-column column-width="4cm" />
                                                                ...
                                                                <fo:table-body>
                                                                        ...
                                                                        <fo:table-row>
                                                                                ...
                                                                                <fo:table-cell>
                                                                                        <fo:block font-family="Roboto Mono" font-weight="bold" text-align-last="left" font-size="10pt">
                                                                                                <xsl:value-of select="bollettino/cf_ente" />
                                                                                        </fo:block>
                                                                                </fo:table-cell>
                                                                        </fo:table-row>
                                                ...
                                                <fo:table-cell>
                                                        <fo:block padding-top="3px" margin-left="1cm" margin-right="1cm" text-align-last="right">
                                                                <fo:inline font-family="Titillium Web" font-weight="normal" font-size="10pt">Euro</fo:inline>
                                                                <fo:leader leader-pattern="space" />
                                                                <fo:inline font-family="Roboto Mono" font-weight="bold" font-size="12pt"> <xsl:value-of select="bollettino/importo" /> </fo:inline>
                                                        </fo:block>
                                                        <fo:block padding-top="3px" margin-left="1cm" margin-right="1cm" text-align="right">
                                                                <fo:external-graphic src="url('barcode/datamatrix_codiceAvviso.jpg')" vertical-align="middle" border-width="thin" content-height="78" content-width="78" />
                                                        </fo:block>
                                                </fo:table-cell>   
                                        </fo:table-row>
                                </fo:table-body>
